 ...
 */
@Slf4j
public class KboparkSentinelInvocationHandler implements InvocationHandler {
	...
	KboparkSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			KboparkSentinelInvocationHandler other = (KboparkSentinelInvocationHandler) obj;
